...
const Offersection = () => {
        return (
                <div className='mt-[138px] mb-[50px] md:mb-[109px]  sm:pt-0'>
                        <div className=' max-w-[1320px] mx-auto px-3'>
                                <div className='flex flex-row flex-wrap -mx-3'>
                                        <div className=' w-full  lg:w-1/2 px-3'>
                                                <div className=' bg-[url(./assets/images/offerimg1.webp)] bg-[100%_100%] bg-cover bg-no-repeat'>
                                        ...
                                        <div className=' w-full lg:w-1/2 px-3 mt-6 lg:mt-0'>
                                                <div className=' bg-[url(./assets/images/offerimg2.webp)] bg-[100%_100%] bg-cover bg-no-repeat'>
                                                        <div className='flex items-center gap-2 md:gap-[11px] pb-5 pt-[32px]'>
                                                                <hr className=' ml-[2px] w-[40px] md:w-[95px] h-[1px] bg-black mr-2' />
